//set main namespace<dat khong gian ten chinh>
goog.provide('farming');   
//get requirements<nhan yeu cau> 
...
//entrypoint <diem nhap>
farming.start = function(){     
    
    //game object<doi tuong trong game>
    var gameObj = {
        width: 320,
        height: 480,
        tile_size: 64,
    ...
    //player object<doi tuong nguoi choi>
    var playerObj = {
        money: 300,
        currentCrop: 0     
    }
    ...
    //controls area<kiem soat khu vuc>
    ...
    //updating money indicator<cap nhat chi so tien>
    gameObj.updateMoney = function() {
        moneyLabel.setText('$'+playerObj.money);
    };
    
    //create land elements<tao ra cac yeu to dat>
